...
def main():
    try:
        ...
        parser.add_argument(
            "--flatten", help="Flatten the tree (list of paths)", action="store_true"
        )
        parser.add_argument(
            "file",
            nargs="?",
        ...
        parser.add_argument(
            "--json-spec", action="store_true", help="Specification of the JSON data"
        )
        ...
        parser.add_argument(
            "--is-connected", help="Check if two nodes are connected", type=str, nargs=2
        )
        parser.add_argument(
            "--get-path", help="Find the path between two nodes", type=str, nargs=2
        )
